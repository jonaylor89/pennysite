...
import { generateUnsubscribeUrl } from "../lib/email/triggers.js";

/**
 * Run the daily email campaign.
 * Ported from GET /api/email/cron — now called by the internal scheduler.
 */
export async function runEmailCampaign(): Promise<Record<string, number>> {
	...
	console.log("Email campaign completed:", results);
	return results;
}
